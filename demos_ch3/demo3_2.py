...
numsamp = 25
sigma2 = sinvchi2.rvs(n-1, s2, size=numsamp)
...
def update_figure(event):
    ...
    if icontainer.stage == 0:
        ...
        line, = ax0.plot(tl1, [sigma[0], sigma[0]], 'k--')
        ...
        i1 = icontainer.i1
        # first sample of sigma2
        icontainer.prev_line1, = ax0.plot(tl1, [sigma[i1], sigma[i1]], 'k--')
        # the conditional distribution of mu given sigma2
